...
LOG_FILE = LOG_DIR + '/sample-app.log'
...
class sample_app_HTTPServer_RequestHandler(BaseHTTPRequestHandler):
...
def run():
  ...
  httpd = HTTPServer(server_address, sample_app_HTTPServer_RequestHandler)
